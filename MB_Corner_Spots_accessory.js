...
var execute = function(accessory,characteristic,value) {
  if(characteristic == lightwaverf.SWITCH){
    if (value) {
      lightwaverf.switchAction('179', lightwaverf.SWITCH_ON);
    }
    else{
      lightwaverf.switchAction('179', lightwaverf.SWITCH_OFF);
    }
  }
  else if(characteristic == lightwaverf.SWITCH_BRIGHTNESS){
    lightwaverf.switchBrightness('179', value);
  }
