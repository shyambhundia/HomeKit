...
var execute = function(accessory,characteristic,value) {
  if(characteristic == lightwaverf.THERMO_SET){
      lightwaverf.setValue('369', value);
  }
  else  if(characteristic == lightwaverf.THERMO_SET){
      return 10;
  } 
  ...
  services: [{
    ...
    characteristics: [{
    	...
    	onUpdate: function(value) { 
    			...
    			var returnVal = execute("Thermostat", "Target Temperature", value); 
